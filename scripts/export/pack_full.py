...
SRC = sys.argv[1] if len(sys.argv) > 1 else "mujammelexport.las"
...
fp.close(); fc.close()
json.dump(dict(n=int(done), lo=lo.tolist(), scale=scale.tolist(),
...
print(f"all {done:,} points, nothing dropped")
